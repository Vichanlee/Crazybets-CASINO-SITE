...
if(config.is_prod) {
	var options_ssl = {
	    key: fs.readFileSync('/etc/letsencrypt/live/crazycasino.cc/privkey.pem', 'utf8').toString(),
	    cert: fs.readFileSync('/etc/letsencrypt/live/crazycasino.cc/fullchain.pem', 'utf8').toString()
	};
